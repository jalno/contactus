	...
	<?php if (!empty($this->getLetters())) { ?>
		<div class="panel panel-default">
			<div class="panel-heading">
				<i class="fa fa-external-link-square"></i> <?php echo t('contactus'); ?>
				<div class="panel-tools">
					<a class="btn btn-xs btn-link tooltips" title="" href="#search" data-toggle="modal" data-original-title="<?php echo t('contactus.search'); ?>"><i class="fa fa-search"></i></a>
	    ...
	    ?>
						<thead>
							<tr>
								<th class="center">#</th>
								<th><?php echo t('contactus.letter.subject'); ?></th>
								<th><?php echo t('contactus.letter.name'); ?></th>
								<th><?php echo t('contactus.letter.email'); ?></th>
								<th><?php echo t('contactus.letter.send_at'); ?></th>
								<th><?php echo t('contactus.letter.status'); ?></th>
...
$feilds = [
    [
        'name' => 'id',
        'type' => 'number',
        'label' => t('contactus.letter.id'),
        'ltr' => true,
    ],
    [
        'name' => 'email',
        'type' => 'email',
        'label' => t('contactus.letter.email'),
        'ltr' => true,
    ],
    [
        'name' => 'word',
        'label' => t('contactus.letter.specific_word'),
    ],
    [
        'type' => 'select',
        'label' => t('contactus.letter.status'),
        'name' => 'status',
...
?>
	...
	<div class="modal-footer">
		<button type="submit" form="letterSearch" class="btn btn-success"><?php echo t('search'); ?></button>
